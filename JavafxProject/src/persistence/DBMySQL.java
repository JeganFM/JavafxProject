...
//    public static Statement stmt;
    ...
    final private static String pwd = "Begaay13";
    final private static String db_name = "project";
    final private static String connection = "jdbc:mysql://localhost:3306/"+db_name;
